...
![Preview](https://github.com/vbnm134678/sketch-code/blob/An-hyeonyoung/image/document_image4.png)
...
모델 생성 프로세스에서 스타일링을 분리하면 모델을 사용할 때 다음과 같은 몇 가지 큰 이점을 얻을 수 있습니다:
