...
### 오늘날의 설계 워크플로우
![Preview](https://github.com/vbnm134678/sketch-code/blob/An-hyeonyoung/image/document_image1.png "설계 워크플로우는 여러 이해 관계자를 거치게 된다.")
...
![Preview](https://github.com/vbnm134678/sketch-code/blob/An-hyeonyoung/image/document_image2.png "그림에서 코드로 변환하는 Airbnb의 내부 AI 툴 데모")
...
![Preview](https://github.com/vbnm134678/sketch-code/blob/An-hyeonyoung/image/header_image.png "SketchCode 모델은 와이어 프레임을 가져와서 HTML 코드를 생성합니다.")
...
![Preview](https://github.com/vbnm134678/sketch-code/blob/An-hyeonyoung/image/document_image3.png "이미지 캡션 모델은 소스 이미지에 대한 설명을 생성합니다.")
...
![Preview](https://github.com/vbnm134678/sketch-code/blob/An-hyeonyoung/image/document_image4.png "생성된 웹 사이트 이미지와 소스코드 (pix2code의 데이터 셋)")
...
![Preview](https://github.com/vbnm134678/sketch-code/blob/An-hyeonyoung/image/document_image5.png "웹 사이트를 손으로 그린 버전으로 바꾸기")
...
![Preview](https://github.com/vbnm134678/sketch-code/blob/An-hyeonyoung/image/document_image6.png "토큰의 시퀀스를 입력으로 사용하여 모델 훈련")
...
![Preview](https://github.com/vbnm134678/sketch-code/blob/An-hyeonyoung/image/document_image7.png "BLEU 점수 시각화")
...
![Preview](https://github.com/vbnm134678/sketch-code/blob/An-hyeonyoung/image/document_image8.png "단일 그림 => 동시에 다양한 디자인을 만들어 낸다.")
